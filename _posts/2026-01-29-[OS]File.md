...
## 🗂️ 1. Files — Logical Data Containers
...
### ⚙️ File Operations (System Calls)
```
...
## 📂 2. Directories — File Organization Structure
...
## 💽 3. File Systems — Disk Management Layer
...
## 🐧 6. UNIX File System — i-node Architecture
...
| Double Indirect | Pointer‑to‑pointer |
...
## 💾 7. Popular File Systems Comparison
...
✔ File allocation affects performance  
✔ Indexed allocation improves random access  
✔ Metadata enables security & ownership  
✔ FAT = portable, NTFS = secure, EXT4 = scalable  
✔ File systems manage fragmentation & disk efficiency  

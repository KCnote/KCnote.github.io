...
# 📜 2. Traditional Language Models: n-grams
...
|----------|-------------|--------------------|
| n-gram   | ❌ exponential | ❌ poor |
| RNN      | ✅ constant | ⚠ limited |
| Deep RNN | ✅ constant | ⚠ better |
